        ...
        for startNode in list(self.graph.nodes):
            for i in range(self.numbOfWalksPerVertex):
                ...
                for k in range(self.walkLength-2):
                    # print("self inverse",walk[-1], self.nodeEncoder.inverse_transform([walk[-1]])[0])
                    # print(list(self.graph[(self.nodeEncoder.inverse_transform([walk[-1]])[0])]))
                    # print(self.graph[int(self.nodeEncoder.inverse_transform([walk[-1]])[0])])
